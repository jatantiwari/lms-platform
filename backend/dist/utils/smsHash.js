...
exports.formatOtpSms = formatOtpSms;
exports.validateAppHash = validateAppHash;
exports.isKnownAppHash = isKnownAppHash;
/**
 * Formats the OTP SMS body with the app hash appended.
 * The hash MUST be the last thing in the message (after two newlines).
 */
function formatOtpSms(options) {
    const { appHash, otp, appName = 'ADI Boost', validMinutes = 5, } = options;
...
//# sourceMappingURL=smsHash.js.map