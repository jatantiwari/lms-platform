...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description: 'Master stock market trading and investing. Learn, Invest, Grow. Ride the Bull, Rule the Bear.',
    url: 'https://financialfreedommentor.com',
    logo: 'https://financialfreedommentor.com/logo.png',
    sameAs: [
      'https://twitter.com/stockmarketmentorship',
      'https://linkedin.com/company/stock-market-mentorship',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'Customer Service',
      telephone: '+1-800-555-1234',
      email: 'hello@stockmarketmentorship.com',
    },
    address: {
      '@type': 'PostalAddress',
